...
dict_markowitz = read_weights(r'files\\Markowitz_weights.csv')
dict_sharpe = read_weights(r'files\\Sharpe_weights.csv')
...
df_markowitz.to_csv(r'files\\Markowitz_2021.csv')
df_sharpe = download_data(dict_sharpe, start_date, end_date)
df_sharpe.to_csv(r'files\\Sharpe_2021.csv')
df_sentiment = download_data(dict_sentiment, start_date, end_date)
df_sentiment.to_csv(r'files\\Sentiment_2021.csv')
...
df_combined.to_csv(r'files\\Weighted_Portfolios.csv')
...
df_result.to_csv(r'files\\Final_Comparison.csv')
