...
df = pd.read_csv(r'files\\sp500_prices.csv', parse_dates=True)
...
write_to_csv(r"files\\Sharpe_weights.csv", assets_sharpe)
write_to_csv(r"files\\Markowitz_weights.csv", assets_min)
